...
class _NewItemState extends State<NewItem> {
  ...
  */
  ...
  if (_formKey.currentState!.validate()) {
    ...
    // Check if _enteredName, _enteredQuantity, and _selectedCategory are not null
    if (_enteredName != null &&
        _enteredQuantity != null &&
        _selectedCategory != null) {

      final url = Uri.https(
          'shopping-app-9e80b-default-rtdb.firebaseio.com',
          'shopping-list.json');
      ...
      // Ensure that the context is still valid before navigating
      if (!context.mounted) {
        return;
      }
